		...
		for(var i = 0; i<data['plans'].length; i++){
			if(data['plans'][i]['name'] === 'Anaerobic'){
				...
				for(var x = 0; x<(today_number-anaerobic_count); x++){
					$('#anaerobic-count-no').append('<span class="glyphicon glyphicon-remove-circle" id="daily-dash-glyph"></span>');
				}
				...
				if(data['plans'][i]['stats']['streak'] > 0){
					$('#anaerobic-today').append('<span class="glyphicon glyphicon-ok" id="daily-dash-glyph"></span>');
				} else {
					$('#anaerobic-today').append('<span class="glyphicon glyphicon-remove" id="daily-dash-glyph"></span>');
				}
				...
				for(var x = 0; x<(today_number-aerobic_count); x++){
					$('#aerobic-count-no').append('<span class="glyphicon glyphicon-remove-circle" id="daily-dash-glyph"></span>');
				}
				for(var x = 0; x<(7-today_number); x++){
					$('#aerobic-count').append('<span class="glyphicon glyphicon-question-sign" id="daily-dash-glyph"></span>');
				}
				if(data['plans'][i]['stats']['streak'] > 0){
					$('#aerobic-today').append('<span class="glyphicon glyphicon-ok" id="daily-dash-glyph"></span>');
				} else {
					$('#aerobic-today').append('<span class="glyphicon glyphicon-remove" id="daily-dash-glyph"></span>');
				}
				...
				for(var x = 0; x<(today_number-eat_fruit_count); x++){
					$('#eat-fruit-count-no').append('<span class="glyphicon glyphicon-remove-circle" id="daily-dash-glyph"></span>');
				}
				for(var x = 0; x<(7-today_number); x++){
					$('#eat-fruit-count').append('<span class="glyphicon glyphicon-question-sign" id="daily-dash-glyph"></span>');
				}
				if(data['plans'][i]['stats']['streak'] > 0){
					$('#eat-fruit-today').append('<span class="glyphicon glyphicon-ok" id="daily-dash-glyph"></span>');
				} else {
					$('#eat-fruit-today').append('<span class="glyphicon glyphicon-remove" id="daily-dash-glyph"></span>');
				}
			} else {
